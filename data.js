window.BET_TRACKER_DATA = {
  ...
  leagues: {
      ...
      weeks: [
        {
          ...
          tickets: [
            ...
            {id:'NCAA-W1-07',category:'3-Team Teaser',betTypeGroup:'Teaser',booked:true,description:'Tulane +13.5 / Auburn -1.5 / Notre Dame -14.5',risk:50,toWin:90,odds:'+180',closingLine:null,closingOdds:null,result:null,pnl:null,settledAt:null,legs:[{gameKey:'tulane-duke',espnEventId:null,team:'Tulane',opponent:'Duke',betType:'spread',line:13.5},{gameKey:'baylor-auburn',espnEventId:null,team:'Auburn',opponent:'Baylor',betType:'spread',line:-1.5},{gameKey:'wisconsin-nd',espnEventId:null,team:'Notre Dame',opponent:'Wisconsin',betType:'spread',line:-14.5}]},
            {id:'NCAA-W1-08',category:'3-Team Underdog Parlay',betTypeGroup:'Parlay',booked:true,description:'San Jose State ML / Wyoming ML / Tulane ML',risk:25,toWin:476,odds:'+1904',closingLine:null,closingOdds:null,result:null,pnl:null,settledAt:null,legs:[{gameKey:'sjsu-emu',espnEventId:null,team:'San Jose State',opponent:'Eastern Michigan',betType:'moneyline'},{gameKey:'wyoming-csu',espnEventId:null,team:'Wyoming',opponent:'Colorado State',betType:'moneyline'},{gameKey:'tulane-duke',espnEventId:null,team:'Tulane',opponent:'Duke',betType:'moneyline'}]},
            {id:'NCAA-W1-09',category:'So Crazy It Just Might Work',betTypeGroup:'Moneyline',booked:true,description:'Toledo ML at Michigan State',risk:25,toWin:85,odds:'+340',closingLine:null,closingOdds:null,result:null,pnl:null,settledAt:null,legs:[{gameKey:'toledo-msu',espnEventId:null,team:'Toledo',opponent:'Michigan State',betType:'moneyline'}]},
    ...
    NFL: {
      label: 'NFL',
      espnPath: 'nfl',
      weeks: [{week:1,label:'Week 1',dateStart:'2026-09-09',dateEnd:'2026-09-14',archived:false,tickets:[]}]
    }
  }
};
