(() => {
  ...
  if (ncaa) {
    ...
    // Week 3 is fully settled. Results are baked directly into the source
    // ticket objects so display does not depend on ESPN refresh or a later patch.
    week3.tickets = [
      {
        ...
        closingLine:null, closingOdds:null, result:'win', pnl:100, settledAt:'2026-09-20T00:45:00-07:00',
        legs:[{gameKey:'miami-wake', espnEventId:'401858226', team:'Wake Forest', opponent:'Miami (FL)', betType:'spread', line:21.5}]
      },
      {
        ...
        closingLine:null, closingOdds:null, result:'loss', pnl:-50, settledAt:'2026-09-20T00:45:00-07:00',
        legs:[{gameKey:'houston-texastech', espnEventId:'401856811', team:'Houston', opponent:'Texas Tech', betType:'moneyline'}]
      },
      {
        ...
        closingLine:null, closingOdds:null, result:'win', pnl:100, settledAt:'2026-09-20T00:45:00-07:00',
        legs:[{gameKey:'ncstate-vandy', espnEventId:'401856695', team:'Vanderbilt', opponent:'NC State', betType:'spread', line:-3}]
      },
      {
        ...
        closingLine:null, closingOdds:null, result:'loss', pnl:-110, settledAt:'2026-09-20T00:45:00-07:00',
        legs:[{gameKey:'kentucky-tamu', espnEventId:'401856694', team:'Texas A&M', opponent:'Kentucky', betType:'spread', line:-17}]
      },
      {
        ...
        closingLine:null, closingOdds:null, result:'win', pnl:68, settledAt:'2026-09-20T00:45:00-07:00',
        legs:[{gameKey:'lsu-olemiss', espnEventId:'401856688', team:'Ole Miss', opponent:'LSU', betType:'moneyline'}]
      },
      {
        ...
        closingLine:null, closingOdds:null, result:'loss', pnl:-50, settledAt:'2026-09-20T00:45:00-07:00',
        legs:[
          {gameKey:'kentucky-tamu', espnEventId:'401856694', team:'Texas A&M', opponent:'Kentucky', betType:'spread', line:-17},
          {gameKey:'ncstate-vandy', espnEventId:'401856695', team:'Vanderbilt', opponent:'NC State', betType:'spread', line:-3}
        ]
      },
      {
        ...
        closingLine:null, closingOdds:null, result:'loss', pnl:-50, settledAt:'2026-09-20T00:45:00-07:00',
        legs:[
          {gameKey:'houston-texastech', espnEventId:'401856811', team:'Houston', opponent:'Texas Tech', betType:'moneyline'},
          {gameKey:'lsu-olemiss', espnEventId:'401856688', team:'Ole Miss', opponent:'LSU', betType:'moneyline'}
        ]
      },
      {
        ...
        closingLine:null, closingOdds:null, result:'loss', pnl:-50, settledAt:'2026-09-20T00:45:00-07:00',
        legs:[
          {gameKey:'miami-wake', espnEventId:'401858226', team:'Wake Forest', opponent:'Miami (FL)', betType:'spread', line:26.5},
          {gameKey:'kentucky-tamu', espnEventId:'401856694', team:'Texas A&M', opponent:'Kentucky', betType:'spread', line:-11},
          {gameKey:'ncstate-vandy', espnEventId:'401856695', team:'Vanderbilt', opponent:'NC State', betType:'spread', line:3}
        ]
      }
    ];
      ...
      tickets: [
        {
          ...
          closingLine:null, closingOdds:null, result:'loss', pnl:-100, settledAt:'2026-09-20T00:45:00-07:00',
          legs:[
            {gameKey:'phi-ten', espnEventId:null, team:'Philadelphia Eagles', opponent:'Tennessee Titans', betType:'spread', line:-7},
            {gameKey:'ncstate-vandy', espnEventId:'401856695', team:'Vanderbilt', opponent:'NC State', betType:'moneyline'},
            {gameKey:'kentucky-tamu', espnEventId:'401856694', team:'Texas A&M', opponent:'Kentucky', betType:'spread', line:-17}
          ]
        },
        {
  ...
  D.config.build = 'v1.8.3';
  D.config.lastSiteUpdate = '2026-09-20T00:45:00-07:00';
})();